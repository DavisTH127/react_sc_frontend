...
<div className="appbarwrapper">
        ...
        <Toolbar>
          ...
          <Typography variant="title" color="inherit" className="headertypoclass" ><Link to="/"> Smart Course</Link></Typography>
          <Button color="inherit" align="right"><Link to="/reviews"> REVIEWS</Link></Button>
          <Button color="inherit" align="right"><Link to="/company"> COMPANY</Link></Button>
          <Button color="inherit" align="right"><Link to="/courses"> COURSES</Link></Button>
          {
